...
impl Table {
    pub fn new() -> Self {
        ...
        // PROGR'
        table.insert(("PROGR'", "h"), "PROGR $");
        table.insert(("PROGR'", "c"), "PROGR $");
        table.insert(("PROGR'", "w"), "PROGR $");
        table.insert(("PROGR'", "i"), "PROGR $");
        table.insert(("PROGR'", "n"), "PROGR $");
        table.insert(("PROGR'", "b"), "PROGR $");
        table.insert(("PROGR'", "s"), "PROGR $");
        table.insert(("PROGR'", "g"), "PROGR $");
        table.insert(("PROGR'", "o"), "PROGR $");
        table.insert(("PROGR'", "r"), "PROGR $");
